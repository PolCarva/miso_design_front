...
const ContactPage = () => {
  ...
  useEffect(() => {
    const fetchConfig = async () => {
      try {
        const response = await fetch(`${STABLES.API_URL}/config/66492e49eb38e1a64a281be9?locale=undefined&draft=false&depth=1`);
  ...
  return (
    <section className="px-5 lg:px-16 mt-5">
      <form onSubmit={handleSubmit} className="md:w-1/2 flex flex-col gap-4 mx-auto">
